...
import { ResponseTimeChartProps } from '@/types/props/ChartProps';
import * as echarts from 'echarts';
import { formatTimeToHHMM } from '@/utils/format';

function LineChart({ isSmooth, chartColor, chartDataValue, chartDataName, responseCodeList }: ResponseTimeChartProps) {
  ...
  }, [isSmooth, chartColor, chartDataValue, chartDataName, responseCodeList]);
