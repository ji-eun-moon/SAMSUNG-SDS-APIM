    ...
    return (
      <div className={`${styles.background} ${animationClass}`}>
        <div
          aria-hidden
          id="toast-notification"
          className="w-full p-4 text-gray-900 bg-white rounded-lg shadow border-2 border-green-600"
          role="alert"
        >
          <div className="flex items-center mb-3 gap-2 justify-between">
            <div className="flex gap-2">
              ...
              <p className="mb-1 text-base font-semibold text-green-600 dark:text-white">
