    ...
    <div className="w-1/2">
      <div className="flex justify-between">
        <div className="flex items-center pb-1">
          ...
          <div className="samsungLogo">사용량 통계</div>
        </div>
        <button type="button" className={styles.goDetail} onClick={() => router.push(userStatisticsUrl)}>
          상세보기
          <svg
              ...
              {useCategoryList &&
                ...
                useCategoryList.map((category: ICategory) => (
                  <div key={category.categoryId} className="w-full">
                    <CategoryUsage categoryId={category.categoryId} teamName={initialTeam} type="use" use="main" />
                  </div>
                ))}
            </Slider>
            {!useCategoryList ||
...
export default MainUseStatistics;
